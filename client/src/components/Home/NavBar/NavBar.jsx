    ...
    return (
        <>
            <div className="navbar-light bg-light navhome shadow d-flex align-items-center pe-4 ps-5" style={{ justifyContent: "space-between", gap: "40px", padding: "18px" }}>
                <div className="navbar-brand logo d-flex align-items-center gap-5" style={{ fontWeight: "900", fontSize: "22px", color: "#ff6a38" }}>
                    ...
                    <div className='d-flex align-items-center hideLinks gap-4'>
                        <Link className='text-decoration-none' style={{fontSize:"19px", color:"#ff6a36"}} to='/'>Home</Link>
                        <Link className='text-decoration-none' style={{fontSize:"19px", color:"#ff6a36"}} to='/products'>Products</Link>
                    </div>
                </div>
                ...
                <div className='me-3 cartitems d-flex align-items-center gap-4'>
                    ...
                    <Link to='/cart' type="button" style={{color: "#ff6a38", border:"1px solid #ff6a31"}} className="btn position-relative">
