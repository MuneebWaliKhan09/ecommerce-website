...
export const productsDetails = createAsyncThunk("productsDetail", async (id, { rejectWithValue }) => {
    const res = await axios.get(`https://ecommerce-muneeb.vercel.app/api/getProductDetails/${id}`)
...
export const productsReveiw = createAsyncThunk("productReveiw", async (data, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/createReview`, data, config)
...
export const createOrder = createAsyncThunk("createOrder", async (order, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.post(`https://ecommerce-muneeb.vercel.app/api/createOrder`, order, config)
...
export const allOrders = createAsyncThunk("allOrders", async (rand, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get(`https://ecommerce-muneeb.vercel.app/api/myOrders`, config)
...
export const orderDetails = createAsyncThunk("orderDetails", async (id, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get(`https://ecommerce-muneeb.vercel.app/api/getSingleOrder/${id}`, config)
...
export const registerUser = createAsyncThunk("auth/register", async (data, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.post("https://ecommerce-muneeb.vercel.app/api/registerUser", data, config);
...
export const loginUser = createAsyncThunk("auth/login", async ({ email: email, password: password }, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.post("https://ecommerce-muneeb.vercel.app/api/loginUser", { email, password }, config);
...
export const logoutUser = createAsyncThunk("auth/logout", async (rand, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get("https://ecommerce-muneeb.vercel.app/api/logoutUser", config);
...
export const loginUserDetails = createAsyncThunk("auth/userDetails", async (rand, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get("https://ecommerce-muneeb.vercel.app/api/getUserDetails", config);
...
export const forgotPasswordUser = createAsyncThunk("forgotPasswordUser", async ({ email: email }, { rejectWithValue }) => {
    ...
    try {
        const res = await axios.post("https://ecommerce-muneeb.vercel.app/api/forgot/password", { email });
        return res.data.msg;
...
export const resetPasswordUser = createAsyncThunk("resetPasswordUser", async ({ password: password, confirmPassword: confirmPassword, token: token }, { rejectWithValue }) => {
    ...
    try {
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/password/reset/${token}`, { password, confirmPassword });
        return res.data.msg;
...
export const updateUserProfile = createAsyncThunk("updateUserProfile", async (data, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/updateUserProfile`, data, config);
        return res.data.msg;
...
export const updateUserPassword = createAsyncThunk("updateUserPassword", async ({ oldPassword: oldPassword, newPassword: newPassword, confirmPassword: confirmPassword }, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/updateUserPassword`, { oldPassword, newPassword, confirmPassword }, config);
        return res.data.msg;
...
export const CreateProduct = createAsyncThunk("CreateProduct", async (data, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.post(`https://ecommerce-muneeb.vercel.app/api/admin/createProduct`, data, config)
        return res.data.msg
...
export const UpdateProduct = createAsyncThunk("UpdateProduct", async ({ id: id, data: data }, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/admin/updateProduct/${id}`, data, config)
        return res.data.msg
...
export const DeleteProduct = createAsyncThunk("DeleteProduct", async (id, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.delete(`https://ecommerce-muneeb.vercel.app/api/admin/deleteProduct/${id}`, config)
        return res.data.msg
...
export const adminOrders = createAsyncThunk("adminOrders", async (rand, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get(`https://ecommerce-muneeb.vercel.app/api/admin/allOrders`, config)
        return res.data
...
export const OrderFinalStatus = createAsyncThunk("OrderFinalStatus", async ({ id: id, status: status }, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/admin/finalStatus/${id}`, requestData, config)
        return res.data.msg
    } catch (error) {
        return rejectWithValue(error.response.data.err);
    }
...
export const DeleteOrder = createAsyncThunk("DeleteOrder", async (id, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.delete(`https://ecommerce-muneeb.vercel.app/api/admin/deleteOrder/${id}`, config)
        return res.data.msg
...
export const AllUsers = createAsyncThunk("AllUsers", async (rand, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get(`https://ecommerce-muneeb.vercel.app/api/admin/getAllUsers`, config)
...
export const UserDetails = createAsyncThunk("UserDetails", async (id, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.get(`https://ecommerce-muneeb.vercel.app/api/admin/getSingleUser/${id}`, config);
        return res.data.user;
...
export const UpdateUserRole = createAsyncThunk("UpdateUser", async ({ id: id, role: role }, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.put(`https://ecommerce-muneeb.vercel.app/api/admin/updateUserRole/${id}`, requestData, config)
        return res.data.msg
...
export const DeleteUser = createAsyncThunk("DeleteProduct", async (id, { rejectWithValue }) => {
    ...
    try {
        ...
        const res = await axios.delete(`https://ecommerce-muneeb.vercel.app/api/admin/deleteUser/${id}`, config)
        return res.data.msg
